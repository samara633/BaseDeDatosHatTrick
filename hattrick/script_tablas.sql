...
VALUES (1, "", 50000, "zapatilla blu", 5, "", "zapatilla",1,1,1,1,1,1),
...
VALUES (1, "hat_trick", "vender zapatos nivel nacional", "vender zapatos nivel nacional", 312514132, 1234567891, "enriquehat_trick@gmail.com", "colombia", "bogota", "cra20-42c"  );
        
 SELECT * FROM empresa;
 
INSERT INTO vendedores (id_vendedor, nompre, apellido, empresa_idempresa)
...
VALUES (1, "Omar", "Gonzales", "omar12@gmail.com", 312569846, "cra15-6", '1973-09-05 00:01:00', 1),
		(2, "Ernesto", "Abril", "er34@gmail.com", 313659846, "cra05-56", '1953-02-03 00:01:00',5 ),
		(3, "Mariano", "Rios","mariano@gmail.com", 312569546, "cra08-63", '1975-09-05 00:01:00', 4),
		(4, "Sara", "Aparicio","sara567@gmail.com", 325639846, "cra15-15", '1973-09-03 00:01:00', 2),
		(5, "Elena","Cubillos", "elenac12@gmail.com", 312587846, "cra09-68", '2000-10-12 00:01:00',3);
