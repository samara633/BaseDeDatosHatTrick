...
-- -----------------------------------------------------
-- Schema proyecto_hat_trick
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema proyecto_hat_trick
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `proyecto_hat_trick` DEFAULT CHARACTER SET utf8 ;
USE `proyecto_hat_trick` ;

-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`metodos_pagos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`metodos_pagos` (
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`carrito_compras`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`carrito_compras` (
  ...
  CONSTRAINT `fk_carrito_compras_metodos_pagos1`
    ...
    REFERENCES `proyecto_hat_trick`.`metodos_pagos` (`id_metodo_pago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`tipos_suelas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`tipos_suelas` (
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`empresa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`empresa` (
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`vendedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`vendedores` (
  ...
  CONSTRAINT `fk_vendedor_empresa1`
    ...
    REFERENCES `proyecto_hat_trick`.`empresa` (`id_empresa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`usuarios` (
  ...
  CONSTRAINT `fk_usuarios_vendedor1`
    ...
    REFERENCES `proyecto_hat_trick`.`vendedores` (`id_vendedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`productos` (
...
-- -----------------------------------------------------
-- Table `proyecto_hat_trick`.`facturas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto_hat_trick`.`facturas` (
  ...
  CONSTRAINT `fk_facturas_carrito_compras1`
    ...
    REFERENCES `proyecto_hat_trick`.`carrito_compras` (`idcarrito_compras` , `metodos_pagos_id_metodo_pago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
